function [Texp,Lexp]=lyapunov(n,rhs_ext_fcn,fcn_integrator,...
                     tstart,stept,tend,ystart,ioutp);
%
...
% This function is a part of MATDS program:
% - toolbox for dynamical system investigation
